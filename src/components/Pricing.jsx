...
const Pricing = () => {
  return (
    <section id="pricing" className=" mt-12 p-4 bg-gray-100 dark:bg-gray-950/30 text-black dark:text-gray-400/80">
      <Heading
        title={"#pricing table"}
        textSmall
        borderSide
      ...
      <div className="flex items-center justify-center overflow-x-hidden">
        <div className="flex flex-col items-center justify-center py-12 relative ">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-20 w-full md:gap-8 py-2  flex-wrap max-w-4xl">
